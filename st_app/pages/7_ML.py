...
age.write(pd.read_csv('st_app/help/age_feature.csv'))
gender.write(pd.read_csv('st_app/help/gender_feature.csv'))

stats_cont = pd.read_csv('st_app/help/v2_stats_cont.csv')
stats_not_cont = pd.read_csv('st_app/help/v2_stats_not_cont.csv')
